...
export default function Recetas(){
    ...
    return(
        ...
        <div id='contenido'>
            ...
            <div id='buttons'>
                <button onClick={BTNingredientes} id='ingredientes'>Por Ingredientes</button>
                <button onClick={BTNreceta} id='receta'>Por Receta</button>
            </div>

            <br/><br/>

            <input placeholder='Busqueda' onChange={(e)=>{setBusqueda(e.target.value)}}></input><br/><br/>
            <button onClick={llamadaAPI} id='hambre'>Tengo Hambre!</button><br/><br/>
        </div>
